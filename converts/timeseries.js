...
function main() {
  ...
  pinescript.indicator("Complex MTF SuperTrend [v5]", ({ overlay: true, max_lines_count: 500, max_labels_count: 500 }));
  ...
  let [st1, dir1] = pinescript.requestSecurity(syminfo.tickerid, tf1, f_supertrend(factor, atrPeriod), ({ gaps: barmerge.gaps_off, lookahead: barmerge.lookahead_off }));
  let [st2, dir2] = pinescript.requestSecurity(syminfo.tickerid, tf2, f_supertrend(factor, atrPeriod), ({ gaps: barmerge.gaps_off, lookahead: barmerge.lookahead_off }));
  let [st3, dir3] = pinescript.requestSecurity(syminfo.tickerid, tf3, f_supertrend(factor, atrPeriod), ({ gaps: barmerge.gaps_off, lookahead: barmerge.lookahead_off }));
  ...
  pinescript.plot(st1, ("ST " + tf1), ({ color: ((dir1 === 1) ? pinescript.color.green : pinescript.color.maroon), linewidth: 2 }));
  pinescript.plot(st2, ("ST " + tf2), ({ color: ((dir2 === 1) ? pinescript.color.green : pinescript.color.maroon), linewidth: 2 }));
  pinescript.plot(st3, ("ST " + tf3), ({ color: ((dir3 === 1) ? pinescript.color.green : pinescript.color.maroon), linewidth: 2 }));
  let bullCount = ((((dir1 === 1) ? 1 : 0) + ((dir2 === 1) ? 1 : 0)) + ((dir3 === 1) ? 1 : 0));
  pinescript.bgcolor(((bullCount === 3) ? pinescript.color.new(pinescript.color.green, 90) : ((bullCount === 0) ? pinescript.color.new(pinescript.color.red, 90) : null)));
  if (state.dash === undefined) state.dash = pinescript.table.new(pinescript.position.top_right, 5, 2, ({ bgcolor: pinescript.color.new(pinescript.color.black, 80) }));
  if (barstate.islastconfirmedhistory) {
    {
      ...
      pinescript.table.cell(state.dash, 1, 0, timeframe.period, ({ text_color: pinescript.color.gray }));
      pinescript.table.cell(state.dash, 1, 1, ((dirCurr === 1) ? "Bullish" : "Bearish"), ({ text_color: ((dirCurr === 1) ? pinescript.color.lime : pinescript.color.red) }));
      pinescript.table.cell(state.dash, 2, 0, tf1, ({ text_color: pinescript.color.gray }));
      pinescript.table.cell(state.dash, 2, 1, ((dir1 === 1) ? "Bullish" : "Bearish"), ({ text_color: ((dir1 === 1) ? pinescript.color.green : pinescript.color.maroon) }));
      pinescript.table.cell(state.dash, 3, 0, tf2, ({ text_color: pinescript.color.gray }));
      pinescript.table.cell(state.dash, 3, 1, ((dir2 === 1) ? "Bull Bullish" : "Bearish"), ({ text_color: ((dir2 === 1) ? pinescript.color.green : pinescript.color.maroon) }));
      pinescript.table.cell(state.dash, 4, 0, tf3, ({ text_color: pinescript.color.gray }));
      pinescript.table.cell(state.dash, 4, 1, ((dir3 === 1) ? "Bullish" : "Bearish"), ({ text_color: ((dir3 === 1) ? pinescript.color.green : pinescript.color.maroon) }));
    }
  }
