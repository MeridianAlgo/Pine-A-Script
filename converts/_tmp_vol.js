...
function main() {
  ...
  pinescript.indicator("Volatility Contraction Score", ({ shorttitle: "VCS", overlay: false }));
  ...
  let consistencyScore = pinescript.min(bonusMax, daysTight);
