...
function main() {
  ...
  pinescript.indicator("Complex MTF SuperTrend [v6]", ({ overlay: true, max_lines_count: 500, max_labels_count: 500 }));
  let atrPeriod = input.int(10, "ATR Period");
  let factor = input.float(3, "Multiplier", ({ step: 0.1 }));
  let tf1 = input.timeframe("60", "Higher TF 1");
  let tf2 = input.timeframe("240", "Higher TF 2");
  let tf3 = input.timeframe("D", "Higher TF 3");
  let tf4 = input.timeframe("W", "Higher TF 4");
  let tf5 = input.timeframe("", "Higher TF 5 (optional)");
  function f_supertrend(_factor, _atrPeriod) {
    let atr = ta.atr(_atrPeriod);
    let up = (hl2 - (_factor * atr));
    let dn = (hl2 + (_factor * atr));
    let up_ = pinescript.nz(pinescript.offset(up, 1), up);
    up = ((pinescript.offset(close, 1) > up_) ? pinescript.max(up, up_) : up);
    let dn_ = pinescript.nz(pinescript.offset(dn, 1), dn);
    dn = ((pinescript.offset(close, 1) < dn_) ? pinescript.min(dn, dn_) : dn);
    let dir = pinescript.nz(pinescript.offset(dir, 1), 1);
    dir = ((close > dn_) ? 1 : ((close < up_) ? -1 : dir));
    let st = ((dir === 1) ? up : dn);
    return [st, dir];
  }
  let [stCurr, dirCurr] = f_supertrend(factor, atrPeriod);
  if (state.st1 === undefined) state.st1 = null;
  if (state.st2 === undefined) state.st2 = null;
  if (state.st3 === undefined) state.st3 = null;
  if (state.st4 === undefined) state.st4 = null;
  if (state.st5 === undefined) state.st5 = null;
  if (state.dir1 === undefined) state.dir1 = null;
  if (state.dir2 === undefined) state.dir2 = null;
  if (state.dir3 === undefined) state.dir3 = null;
  if (state.dir4 === undefined) state.dir4 = null;
  if (state.dir5 === undefined) state.dir5 = null;
  if ((tf1 !== "")) {
    {
      [st1, dir1] = pinescript.requestSecurity(syminfo.tickerid, tf1, f_supertrend(factor, atrPeriod), ({ gaps: barmerge.gaps_off, lookahead: barmerge.lookahead_off }));
    }
  }
  if ((tf2 !== "")) {
    {
      [st2, dir2] = pinescript.requestSecurity(syminfo.tickerid, tf2, f_supertrend(factor, atrPeriod), ({ gaps: barmerge.gaps_off, lookahead: barmerge.lookahead_off }));
    }
  }
  if ((tf3 !== "")) {
    {
      [st3, dir3] = pinescript.requestSecurity(syminfo.tickerid, tf3, f_supertrend(factor, atrPeriod), ({ gaps: barmerge.gaps_off, lookahead: barmerge.lookahead_off }));
    }
  }
  if ((tf4 !== "")) {
    {
      [st4, dir4] = pinescript.requestSecurity(syminfo.tickerid, tf4, f_supertrend(factor, atrPeriod), ({ gaps: barmerge.gaps_off, lookahead: barmerge.lookahead_off }));
    }
  }
  if ((tf5 !== "")) {
    {
      [st5, dir5] = pinescript.requestSecurity(syminfo.tickerid, tf5, f_supertrend(factor, atrPeriod), ({ gaps: barmerge.gaps_off, lookahead: barmerge.lookahead_off }));
    }
  }
  let pCurr = pinescript.plot(stCurr, "Current SuperTrend", ({ color: ((dirCurr === 1) ? pinescript.color.lime : pinescript.color.red), linewidth: 2 }));
  pinescript.plot(((tf1 !== "") ? state.st1 : null), ("ST " + tf1), ({ color: (((tf1 !== "") && (state.dir1 === 1)) ? pinescript.color.green : pinescript.color.maroon), linewidth: 2 }));
  pinescript.plot(((tf2 !== "") ? state.st2 : null), ("ST " + tf2), ({ color: (((tf2 !== "") && (state.dir2 === 1)) ? pinescript.color.green : pinescript.color.maroon), linewidth: 2 }));
  pinescript.plot(((tf3 !== "") ? state.st3 : null), ("ST " + tf3), ({ color: (((tf3 !== "") && (state.dir3 === 1)) ? pinescript.color.green : pinescript.color.maroon), linewidth: 2 }));
  pinescript.plot(((tf4 !== "") ? state.st4 : null), ("ST " + tf4), ({ color: (((tf4 !== "") && (state.dir4 === 1)) ? pinescript.color.green : pinescript.color.maroon), linewidth: 2 }));
  pinescript.plot(((tf5 !== "") ? state.st5 : null), ("ST " + tf5), ({ color: (((tf5 !== "") && (state.dir5 === 1)) ? pinescript.color.green : pinescript.color.maroon), linewidth: 2 }));
  let activeCount = ((((((tf1 !== "") ? 1 : 0) + ((tf2 !== "") ? 1 : 0)) + ((tf3 !== "") ? 1 : 0)) + ((tf4 !== "") ? 1 : 0)) + ((tf5 !== "") ? 1 : 0));
  let bullCount = (((((((tf1 !== "") && (state.dir1 === 1)) ? 1 : 0) + (((tf2 !== "") && (state.dir2 === 1)) ? 1 : 0)) + (((tf3 !== "") && (state.dir3 === 1)) ? 1 : 0)) + (((tf4 !== "") && (state.dir4 === 1)) ? 1 : 0)) + (((tf5 !== "") && (state.dir5 === 1)) ? 1 : 0));
  pinescript.bgcolor((((activeCount > 0) && (bullCount === activeCount)) ? pinescript.color.new(pinescript.color.green, 90) : (((activeCount > 0) && (bullCount === 0)) ? pinescript.color.new(pinescript.color.red, 90) : null)));
  if (state.dash === undefined) state.dash = pinescript.table.new(pinescript.position.top_right, 6, 2, ({ bgcolor: pinescript.color.new(pinescript.color.black, 80) }));
  if (barstate.islastconfirmedhistory) {
    {
      pinescript.table.cell(state.dash, 0, 0, "Timeframe", ({ text_color: pinescript.color.white }));
      pinescript.table.cell(state.dash, 0, 1, "Trend", ({ text_color: pinescript.color.white }));
      let row = 1;
      pinescript.table.cell(state.dash, row, 0, timeframe.period, ({ text_color: pinescript.color.gray }));
      pinescript.table.cell(state.dash, row, 1, ((dirCurr === 1) ? "Bullish" : "Bearish"), ({ text_color: ((dirCurr === 1) ? pinescript.color.lime : pinescript.color.red) }));
      row += 1;
      if ((tf1 !== "")) {
        {
          pinescript.table.cell(state.dash, row, 0, tf1);
          pinescript.table.cell(state.dash, row, 1, ((state.dir1 === 1) ? "Bullish" : "Bearish"), ({ text_color: ((state.dir1 === 1) ? pinescript.color.green : pinescript.color.maroon) }));
          row += 1;
        }
      }
      if ((tf2 !== "")) {
        {
          pinescript.table.cell(state.dash, row, 0, tf2);
          pinescript.table.cell(state.dash, row, 1, ((state.dir2 === 1) ? "Bullish" : "Bearish"), ({ text_color: ((state.dir2 === 1) ? pinescript.color.green : pinescript.color.maroon) }));
          row += 1;
        }
      }
      if ((tf3 !== "")) {
        {
          pinescript.table.cell(state.dash, row, 0, tf3);
          pinescript.table.cell(state.dash, row, 1, ((state.dir3 === 1) ? "Bullish" : "Bearish"), ({ text_color: ((state.dir3 === 1) ? pinescript.color.green : pinescript.color.maroon) }));
          row += 1;
        }
      }
      if ((tf4 !== "")) {
        {
          pinescript.table.cell(state.dash, row, 0, tf4);
          pinescript.table.cell(state.dash, row, 1, ((state.dir4 === 1) ? "Bullish" : "Bearish"), ({ text_color: ((state.dir4 === 1) ? pinescript.color.green : pinescript.color.maroon) }));
          row += 1;
        }
      }
      if ((tf5 !== "")) {
        {
          pinescript.table.cell(state.dash, row, 0, tf5);
          pinescript.table.cell(state.dash, row, 1, ((state.dir5 === 1) ? "Bullish" : "Bearish"), ({ text_color: ((state.dir5 === 1) ? pinescript.color.green : pinescript.color.maroon) }));
        }
      }
    }
  }
  alertcondition(ta.change(dirCurr), "Current TF Trend Flip", "SuperTrend flipped on current TF");
  alertcondition(((tf1 !== "") && ta.change(state.dir1)), "TF1 Trend Flip", ("SuperTrend flipped on " + tf1));
  alertcondition(((tf2 !== "") && ta.change(state.dir2)), "TF2 Trend Flip", ("SuperTrend flipped on " + tf2));
  alertcondition(((tf3 !== "") && ta.change(state.dir3)), "TF3 Trend Flip", ("SuperTrend flipped on " + tf3));
  alertcondition(((tf4 !== "") && ta.change(state.dir4)), "TF4 Trend Flip", ("SuperTrend flipped on " + tf4));
  alertcondition(((tf5 !== "") && ta.change(state.dir5)), "TF5 Trend Flip", ("SuperTrend flipped on " + tf5));
}
