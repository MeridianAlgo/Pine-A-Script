...
function main() {
  ...
  pinescript.barcolor((enable_barcolor ? ((state.trend_direction === 1) ? pinescript.color.new(bullish_color, 20) : pinescript.color.new(bearish_color, 20)) : null), ({ title: "Trend Bar Color" }));
  pinescript.alertcondition(trend_turned_bullish, ({ title: "Bullish Trend Signal", message: "Volume Weighted Trend: BULLISH trend confirmed on {{exchange}}:{{ticker}} - {{interval}}" }));
  pinescript.alertcondition(trend_turned_bearish, ({ title: "Bearish Trend Signal", message: "Volume Weighted Trend: BEARISH trend confirmed on {{exchange}}:{{ticker}} - {{interval}}" }));
  pinescript.alertcondition(trend_changed, ({ title: "Trend Direction Changed", message: "Volume Weighted Trend: Trend direction changed on {{exchange}}:{{ticker}} - {{interval}}" }));
}
